// ============================================================
// Gloop RVM — Master ESP32-S3
// Role: Label camera (side view) + Solenoid + Scoring
//
// Flow:
//   Sensor detects bottle → capture label JPEG → POST to Cloud
//   Function (uploadBottleImage) → poll Firestore for AI result
...
void setup() {
  Serial.begin(115200);
  delay(300);
  Serial.println("Gloop Master ESP32-S3 starting...");
